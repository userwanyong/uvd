"""
A-Bogus 签名算法 —— 纯 Python 实现
来源: https://github.com/Evil0ctal/Douyin_TikTok_Download_API (Apache 2.0)
原始作者: https://github.com/JoeanAmier/TikTokDownloader (GPL 3.0)
用于生成抖音 Web API 的 a_bogus 参数
"""
